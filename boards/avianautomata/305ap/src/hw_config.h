...
#define BOARD_USB_VBUS_SENSE_DISABLED  /* No VBUS sensing - bus-powered */
#define GPIO_OTGFS_VBUS /* PE15 NC */ (GPIO_INPUT|GPIO_PULLUP|GPIO_SPEED_2MHz|GPIO_PORTE|GPIO_PIN15)
#define INTERFACE_USART                1
#define INTERFACE_USART_CONFIG         "/dev/ttyS0,115200"
#define BOOT_DELAY_ADDRESS             0x000001a0
#define BOARD_TYPE                     12100
...
#define BOARD_PIN_LED_BOOTLOADER       GPIO_nLED_BLUE  // BLUE  - blinks while waiting
#define BOARD_PIN_LED_ACTIVITY         GPIO_nLED_GREEN // GREEN - solid while flashing
